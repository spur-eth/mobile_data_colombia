...
def count_visits_over_time(
    ...
    if normalize == True:
        ...
        normalized_visits_grouped = num_users_per_month.merge(
            visits_grouped["count"], left_index=True, right_index=True
        )
        normalized_visits_grouped["count_normalized_nusers"] = (
            normalized_visits_grouped["count"] / normalized_visits_grouped["uid"]
        )
